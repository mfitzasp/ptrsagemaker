...
if len(npyframes) > 0:
    ...
    while counter < 5:
        for frame in npyframes:
            ...
            beforememory=process.memory_info().rss
            #beforememory=psutil.virtual_memory().used
            ...
            aftermemory=process.memory_info().rss
            #aftermemory=psutil.virtual_memory().used
            print (aftermemory - beforememory)
            npyramoverhead.append(aftermemory - beforememory)
...
if len(fitsframes) > 0:
    ...
    while counter < 5:
        for frame in fitsframes:
            ...
            #psutil.virtual_memory().used
            print (aftermemory - beforememory)
            fitsramoverhead.append(aftermemory - beforememory)
...
print ("npy average RAM used: "+ str(np.median(npyramoverhead)))
...
print ("fits average RAM used: "+ str(np.median(fitsramoverhead)))
